...
function draw() {
  ...
  stroke(0);
  // If mouse is pressed, draw line between previous and current mouse positions using---  pmouseX, pmouseY, mouseX, mouseY
  if (mouseIsPressed) {
...
function gotResult(error, results) {
  ...
  //extract results using   results[0].label
...
function check_sketch()
{
  ...
  if(timer_counter > 400)
    ...
    //Add if (timer_check =="completed" || answer_holder == "set")
